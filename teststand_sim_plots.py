...
from ROOT import gROOT,gStyle,TH1F,TChain,TCanvas,TLegend
import ROOT
import array, math
#import numpy as np
import os
...
if __name__=="__main__":
 ...
 for particleEnergy in ([1,1.6,2,3,4,5,5.6] if particle=="Electron" else [5]): #[2,3,4,5,6,7,8,9,10]
  ...
  events.Add("gensimdigireco_muon5_testcosmic_500events_x2_y160_z400_digitiser_mipthreshold_granularity15_adjusted.root")
  i=0
  for event in events:
