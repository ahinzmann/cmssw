...
XMLIdealGeometryESSource = cms.ESSource("XMLIdealGeometryESSource",
    geomXMLFiles = cms.vstring('Geometry/CMSCommonData/data/materials.xml',
                               ...
                               'Geometry/HGCalCommonData/data/hgcal/v19ng/hgcal.xml', # from https://github.com/cms-sw/cmssw/blob/master/Geometry/CMSCommonData/python/cmsExtendedGeometryRun4D123XML_cfi.py
