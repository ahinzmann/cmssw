...
puppi = cms.EDProducer("PuppiProducer",#cms.PSet(#"PuppiProducer",
                       ...
                       UseVertexFitAssociation = cms.bool(True),
                       UseFromPVLooseTight = cms.bool(False),
                       UseDeltaZCut   = cms.bool(True),
                       UseDeltaZSignficanceCut = cms.bool(False),
                       UseTimeSignificanceCut = cms.bool(False),
                       DeltaZCut      = cms.double(0.3),
		       DeltaZSignificanceCut = cms.double(3.),
		       TimeSignificanceCut = cms.double(3.),
